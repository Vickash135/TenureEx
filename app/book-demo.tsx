...
export default function BookDemoPage() {
  ...
  if (success) {
    return <LinearGradient colors={["#F8FAFC", "#EFF6FF"]} style={styles.successPage}>
      <View style={styles.successCard}>
        ...
        <Pressable style={styles.successButton} onPress={() => router.replace("/")}>
          <Text style={styles.successButtonText}>Back to TenureEx</Text>
  ...
  return <ScrollView style={styles.page} contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
    <View style={[styles.shell, !desktop && styles.shellStack]}>
      <LinearGradient colors={["#071A3D", "#0F2A5F", "#1D4ED8"]} style={[styles.story, !desktop && styles.storyMobile]}>
        ...
        <View style={styles.storyContent}>
          ...
          <View style={styles.visualStage}>
            <Animated.View style={[styles.orbitCard, styles.cardBack, { transform: [{ translateY: float }, { perspective: 800 }, { rotateY: "-12deg" }] }]}><MaterialCommunityIcons name="home-city-outline" size={28} color="#BFDBFE" /><Text style={styles.visualLabel}>Properties</Text></Animated.View>
      ...
      <View style={styles.formSide}>
        <View style={styles.formWrap}>
          ...
          <View style={[styles.row, compact && styles.rowStack]}>
            <View style={styles.fieldHalf}><Text style={styles.label}>First name</Text><TextInput value={firstName} onChangeText={setFirstName} placeholder="First name" placeholderTextColor="#94A3B8" style={styles.input} /></View>
            <View style={styles.fieldHalf}><Text style={styles.label}>Last name</Text><TextInput value={lastName} onChangeText={setLastName} placeholder="Last name" placeholderTextColor="#94A3B8" style={styles.input} /></View>
          </View>
          <Text style={styles.label}>Email address</Text>
          <TextInput value={email} onChangeText={setEmail} placeholder="you@company.co.uk" placeholderTextColor="#94A3B8" keyboardType="email-address" autoCapitalize="none" style={styles.input} />
...
const styles = StyleSheet.create({
  page: { flex: 1, backgroundColor: "#F7FAFA" }, shell: { minHeight: Platform.OS === "web" ? "100vh" as any : 900, flexDirection: "row" }, shellStack: { flexDirection: "column" }, story: { width: "48%", minHeight: 760, padding: 42, overflow: "hidden" }, storyMobile: { width: "100%", minHeight: 650, padding: 24 }, storyGrid: { ...StyleSheet.absoluteFillObject, opacity: .12, borderWidth: 1, borderColor: "rgba(255,255,255,.18)" }, back: { flexDirection: "row", alignItems: "center", gap: 8, alignSelf: "flex-start", zIndex: 2 }, backText: { color: "#DBEAFE", fontSize: 13, fontWeight: "700" }, storyContent: { flex: 1, justifyContent: "center", maxWidth: 600, alignSelf: "center", width: "100%" }, kicker: { alignSelf: "flex-start", flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 12, paddingVertical: 7, borderRadius: 20, borderWidth: 1, borderColor: "rgba(96,165,250,.55)", backgroundColor: "rgba(96,165,250,.10)" }, kickerDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: GOLD }, kickerText: { color: "#BFDBFE", fontSize: 11, fontWeight: "900", letterSpacing: 1.1 }, storyTitle: { marginTop: 24, color: "#fff", fontSize: 50, lineHeight: 56, fontWeight: "900", letterSpacing: -1.6 }, storyTitleSmall: { fontSize: 39, lineHeight: 45 }, storyText: { marginTop: 18, color: "#DBEAFE", fontSize: 16, lineHeight: 26, maxWidth: 530 }, points: { marginTop: 25, gap: 11 }, point: { flexDirection: "row", alignItems: "center", gap: 10 }, check: { width: 24, height: 24, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(37,99,235,.90)" }, pointText: { color: "#EFF6FF", fontSize: 13, fontWeight: "600" }, visualStage: { height: 245, marginTop: 34, position: "relative" }, orbitCard: { position: "absolute", borderRadius: 18, borderWidth: 1, borderColor: "rgba(255,255,255,.18)", backgroundColor: "rgba(255,255,255,.10)", shadowColor: "#000", shadowOpacity: .25, shadowRadius: 20, shadowOffset: { width: 0, height: 12 } }, cardBack: { width: 150, height: 110, left: 10, top: 36, padding: 18 }, cardMain: { width: 285, height: 190, left: "23%", top: 12, padding: 24, backgroundColor: "rgba(15,42,95,.90)" }, cardFront: { width: 145, height: 105, right: 4, bottom: 0, padding: 17 }, visualLabel: { color: "#fff", marginTop: 11, fontWeight: "800", fontSize: 13 }, visualLogo: { width: 45, height: 45, borderRadius: 13, backgroundColor: TEAL, alignItems: "center", justifyContent: "center" }, visualTitle: { color: "#fff", fontSize: 18, fontWeight: "900", marginTop: 14 }, visualBars: { gap: 9, marginTop: 17 }, visualTrack: { height: 7, borderRadius: 4, backgroundColor: "rgba(255,255,255,.13)", overflow: "hidden" }, visualFill: { height: "100%", borderRadius: 4, backgroundColor: "#60A5FA" }, formSide: { width: "52%", paddingHorizontal: 34, paddingVertical: 46, justifyContent: "center", backgroundColor: "#F8FAFC" }, formWrap: { width: "100%", maxWidth: 620, alignSelf: "center", backgroundColor: "#fff", borderRadius: 24, padding: 34, borderWidth: 1, borderColor: "#DBEAFE", shadowColor: "#1E3A8A", shadowOpacity: .08, shadowRadius: 24, shadowOffset: { width: 0, height: 10 } }, formEyebrow: { color: TEAL, fontSize: 12, fontWeight: "900", letterSpacing: 1.4 }, formTitle: { color: NAVY, fontSize: 31, lineHeight: 38, fontWeight: "900", marginTop: 8 }, formSub: { color: MUTED, fontSize: 14, lineHeight: 22, marginTop: 8, marginBottom: 20 }, row: { flexDirection: "row", gap: 12 }, rowStack: { flexDirection: "column", gap: 0 }, fieldHalf: { flex: 1 }, label: { color: TEXT, fontSize: 12, fontWeight: "800", marginTop: 13, marginBottom: 7 }, input: { minHeight: 50, borderWidth: 1, borderColor: "#CBD5E1", borderRadius: 12, paddingHorizontal: 14, color: TEXT, fontSize: 14, backgroundColor: "#F8FAFC", outlineStyle: Platform.OS === "web" ? "none" as any : undefined }, select: { minHeight: 50, borderWidth: 1, borderColor: "#CBD5E1", borderRadius: 12, paddingHorizontal: 14, backgroundColor: "#F8FAFC", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, selectText: { color: TEXT, fontSize: 14, fontWeight: "600" }, placeholder: { color: "#94A3B8", fontWeight: "400" }, menu: { borderWidth: 1, borderColor: "#CBD5E1", borderRadius: 12, marginTop: 6, overflow: "hidden", backgroundColor: "#fff" }, menuItem: { minHeight: 43, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderBottomWidth: 1, borderBottomColor: "#EFF6FF" }, menuText: { color: TEXT, fontSize: 13, fontWeight: "600" }, dateGrid: { flexDirection: "row", flexWrap: "wrap", gap: 7, marginTop: 8 }, dateChip: { width: 74, paddingVertical: 9, borderRadius: 10, borderWidth: 1, borderColor: "#CBD5E1", alignItems: "center", backgroundColor: "#fff" }, dateDay: { color: MUTED, fontSize: 10, fontWeight: "700" }, dateLabel: { color: TEXT, fontSize: 12, fontWeight: "800", marginTop: 2 }, chipSelected: { backgroundColor: TEAL, borderColor: TEAL }, chipTextSelected: { color: "#fff" }, timeGrid: { flexDirection: "row", flexWrap: "wrap", gap: 7, marginTop: 8 }, timeChip: { minWidth: 65, paddingHorizontal: 12, paddingVertical: 10, borderRadius: 10, borderWidth: 1, borderColor: "#CBD5E1", alignItems: "center" }, timeText: { color: TEXT, fontSize: 12, fontWeight: "800" }, errorBox: { flexDirection: "row", gap: 8, alignItems: "center", backgroundColor: "#FFF2F2", borderRadius: 10, padding: 11, marginTop: 14 }, errorText: { flex: 1, color: "#8F3333", fontSize: 12, lineHeight: 18 }, submitBtn: { minHeight: 54, borderRadius: 13, backgroundColor: TEAL, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 20 }, submitText: { color: "#fff", fontSize: 14, fontWeight: "900" }, privacy: { textAlign: "center", color: "#64748B", fontSize: 11, lineHeight: 17, marginTop: 12 }, successPage: { flex: 1, minHeight: Platform.OS === "web" ? "100vh" as any : 700, alignItems: "center", justifyContent: "center", padding: 22 }, successCard: { width: "100%", maxWidth: 560, backgroundColor: "#fff", borderRadius: 26, paddingHorizontal: 42, paddingVertical: 40, alignItems: "center", borderWidth: 1, borderColor: "#DBEAFE", shadowColor: "#1E3A8A", shadowOpacity: .08, shadowRadius: 24, shadowOffset: { width: 0, height: 10 } }, successIcon: { width: 76, height: 76, borderRadius: 38, backgroundColor: "#DBEAFE", alignItems: "center", justifyContent: "center" }, successTitle: { color: NAVY, fontSize: 27, fontWeight: "900", textAlign: "center", marginTop: 20 }, successText: { color: MUTED, fontSize: 14, lineHeight: 23, textAlign: "center", marginTop: 10, maxWidth: 450 },
  successButton: { minHeight: 52, minWidth: 190, paddingHorizontal: 24, borderRadius: 13, backgroundColor: TEAL, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 24 },
  successButtonText: { color: "#fff", fontSize: 14, fontWeight: "900", textAlign: "center" },
});
